...
#     with open("\\home\\rj\\Desktop\\Rjfolder\\myproject4\\myproject3\\myapp\\logger.txt", "a") as myfile:
...
#                     prediction_list.append(name_entity)
#                     Logger("prediction list if " + str(sent2) )
#             else:
#                 if sent2[x][0] != " ":
#                     name_entity = sent2
#                     prediction_list.append(str(name_entity) + "<br> {oops! nltk seems confused..}")
#                     Logger("prediction list if " + str(sent2) )
#                 pass
...
#         const_arr = a[0][i]
# if const_arr != 1:
#     print("intent not identified")
# else:
#     print("nice identified")
